...
(
		...
		function($rootScope, $scope, $sce)
		{
			...
			{
				// In the local Windows installer we allow all users to generate and delete outputs.
				// If you want to restrict this to administrators only, change this back to:
