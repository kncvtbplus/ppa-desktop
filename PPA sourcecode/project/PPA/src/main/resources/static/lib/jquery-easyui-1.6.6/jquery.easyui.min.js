...
var measure=dlg.clone().css({position:"absolute",left:-10000,top:-10000,visibility:"hidden",display:"block",width:"auto",height:"auto",maxWidth:"none",maxHeight:"none"}).appendTo("body");
...
measure.remove();
dlg.dialog("resize",{width:w});
dlg.dialog("center");
var winEl=dlg.dialog("dialog");
var currentH=(winEl._outerHeight?winEl._outerHeight():winEl.outerHeight());
if(currentH>maxH){
dlg.dialog("resize",{width:w,height:maxH});
dlg.dialog("center");
}
}catch(e){}
},0);
