...
public class UnescapedDataAttributeProcessor extends AbstractProcessor implements IElementTagProcessor
{
	...
	public UnescapedDataAttributeProcessor(TemplateMode templateMode, String dialectPrefix)
	{
	...
	private void processDataAttribute
	(
			ITemplateContext context,
			IProcessableElementTag tag,
	...
	)
	{
		try
		{
			...
			// do not escape attribute value
			String newAttributeValue = (expressionResult == null ? null : expressionResult.toString());
			...
			{
				structureHandler.replaceAttribute(attributeName, newAttributeName,
		...
		{
			throw new TemplateProcessingException("Error during execution of processor '" + getClass().getName() + "'",
