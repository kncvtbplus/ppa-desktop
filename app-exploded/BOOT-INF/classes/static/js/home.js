...
(
		...
		function($rootScope, $scope, $sce, $window, $timeout, $location)
		{
			...
			$scope.forgotUsernamePasswordHrefText = getMessage("loginUser.form.forgotUsernamePasswordHrefText");
			...
			$scope.initializeRegisterUserForm = function()
			{
				...
				$("#registerUser-form-usernameConfirmation").textbox
				(
						{
							cls: "background-icon-user",
							prompt: getMessage("registerUser.form.username"),
							required: true,
							validType: "equals['#registerUser-form-username']",
